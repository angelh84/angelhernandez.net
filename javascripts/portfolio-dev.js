$(document).ready(function() {
	...
	function portfolioConstructor(type, name, description, imgCount, url){
		this.type = type;
		this.name = name;
	...
	var CasaDelSol = new portfolioConstructor("website", "Casa Del Sol", "Guesthouse Accomodations", 3, "http://www.MyCasaDelSol.com");
	var HapiFoundation = new portfolioConstructor("website", "Hapi Foundation", "Community Health Program", 2, "http://www.HapiApts.org");
	var Crackenback = new portfolioConstructor("website", "Crackenback", "Guesthouse Accomodations", 3, "http://www.Crackenback.com");
	var EuchnerPerformance = new portfolioConstructor("email", "Euchner Performance", "Real Estate Consulting", 3, "http://www.EuchnerPerformance.com");
	
	var portfolioBoxContent = ['<div class="portfolio-box" id="', '"><div class="plaque"><h5>', '</h5><h6>', '</h6></div>', '<div class="boxThumb"></div></div>'];

	console.log(itemID[0].name)
	
	for( var i = 0; i < itemID.length; i++ ){
		var portItem = eval(itemID[i]);
		var type = portItem.type;
		if (type === "website"){
			console.log("This is a " + type + " and the name is " + portItem.name);
		} else if (type === "email") {
			console.log("This is an " + type + " and the name is " + portItem.name)
		} else if (type === "misc") {
    ...
    var portfolioData = {
      websites: [
        ...
        {"id" : "euchner", "name" : "Euchner Performance", "description" : "Real Estate Consulting", "imgCount" : 3, "url" : "http://www.EuchnerPerformance.com"},
        {"id" : "mcResidential", "name" : "MC Residential", "description" : "Property Management", "imgCount" : 3, "url" : "http://www.MCresidential.com"},
