...
$(function () {
    ...
    // Pie chart - reason code
    // ------------------------------

    var pie_chart = c3.generate({
        bindto: '#c3-pie-chart-reason',
        size: { width: 350 },
        color: {
    ...
    // Pie chart - price point
    // ------------------------------

    var pie_chart = c3.generate({
        bindto: '#c3-pie-chart-price',
        size: { width: 350 },
        color: {
            pattern: ['#3F51B5', '#FF9800', '#4CAF50', '#00BCD4', '#F44336']
        },
    ...
    // Generate chart for chargebacks
    var line_chart = c3.generate({
        bindto: '#c3-line-chart-chargebacks',
        point: { 
            r: 4   
        },
        size: { height: 400 },
    ...
    // Generate chart for chargeback ratios
    var line_chart = c3.generate({
        bindto: '#c3-line-chart-ratios',
        point: { 
            r: 4   
        },
        size: { height: 400 },
